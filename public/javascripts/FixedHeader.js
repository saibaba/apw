...
FixedHeader.prototype = {
    ...
    fnInit: function ( oTable, oInit )
    {
        ...
        s.bUseAbsPos = false; // (jQuery.support.msie && (jQuery.browser.version=="6.0"||jQuery.browser.version=="7.0"));
    ...
    fnInitSettings: function ( s, oInit )
    {
         ...
         * compatibility
         */
        s.bUseAbsPos = false; // (jQuery.browser.msie && (jQuery.browser.version=="6.0"||jQuery.browser.version=="7.0"));
    },
    ...
    _fnCloneTLeft: function ( oCache )
    {
        ...
        var bRubbishOldIE = false; // ($.browser.msie && ($.browser.version == "6.0" || $.browser.version == "7.0"));
    ...
    "fnEqualiseHeights": function ( parent, original, clone )
    {
        var that = this,
            ...
            bRubbishOldIE = false; //($.browser.msie && ($.browser.version == "6.0" || $.browser.version == "7.0"));
